...
export type RawOrigin_184 = RawOrigin_184_Root | RawOrigin_184_Signed | RawOrigin_184_None

export interface RawOrigin_184_Root {
  __kind: 'Root'
}

export interface RawOrigin_184_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_184_None {
  __kind: 'None'
}

export type RawOrigin_185 = RawOrigin_185_EthereumTransaction

export interface RawOrigin_185_EthereumTransaction {
